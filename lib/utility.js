...
class Utility {
    constructor() {
      this.SATS = process.env.SATS; // Don't change this setting unless you know what you're doing
      this.PERBYTE = process.env.PERBYTE; // Don't change this setting unless you know what you're doing
